...
class CandidateSchema(ma.Schema):
    ...
    full_name             = fields.String(required=True,validate=validate.Length(1), error_messages={"required": "name is required."})
    date_of_birth         = fields.String(required=True,validate=validate.Length(1), error_messages={"required": "date of birth is required."})
